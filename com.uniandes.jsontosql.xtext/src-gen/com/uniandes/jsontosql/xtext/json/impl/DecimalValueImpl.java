 ...
 * <ul>
 *   <li>{@link com.uniandes.jsontosql.xtext.json.impl.DecimalValueImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DecimalValueImpl extends ValueImpl implements DecimalValue
{
  ...
  {
    return JsonPackage.Literals.DECIMAL_VALUE;
  }
  ...
  public void setValue(double newValue)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, JsonPackage.DECIMAL_VALUE__VALUE, oldValue, value));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case JsonPackage.DECIMAL_VALUE__VALUE:
        return getValue();
    }
